  ...
  return (
    <div className='py-8'>
     ...
     <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8'>
        ...
        {/* second col */}
        <div className='py-10 pl-5 bg-gradient-to-br from-brandYellow 90 to-brandYellow/90 text-white 
        rounded-3xl relative h-[320px] flex items-end'>
           <div >
           <div className='mb-4'>
        ...
        {/* third col */}
        <div className='col-span-2 py-10 pl-5 bg-gradient-to-br from-primary 90 to-primary/90 text-white 
        rounded-3xl relative h-[320px] flex items-end'>
           <div className=''>
           <div className='mb-4'>
